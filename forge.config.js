...
const productName = 'Hagihub';
const appId = 'com.hagicode.hagihub';
const description = 'HagiCode hub desktop application';
const authorName = 'newbe36524';
const homepage = 'https://github.com/HagiCode-org/Hagihub';
