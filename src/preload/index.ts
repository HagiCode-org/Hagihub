...
const hagihubApi = {
  ...
  fetchActionRecommendations: (accountId: string, owner: string, repo: string) => ipcRenderer.invoke('hagihub:fetch-action-recommendations', accountId, owner, repo) as Promise<FetchActionRecommendationsResult>,
