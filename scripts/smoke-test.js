...
const requirePackage = process.env.HAGIHUB_SMOKE_TEST_REQUIRE_PACKAGE === '1';
const allowDirOnly = process.env.HAGIHUB_SMOKE_TEST_ALLOW_DIR_ONLY === '1';
const expectedPlatform = process.env.HAGIHUB_SMOKE_TEST_EXPECT_PLATFORM || '';
const expectedTarget = process.env.HAGIHUB_SMOKE_TEST_EXPECT_TARGET || '';
